...
import AdReadthedocs from "./AdReadthedocs";
...
const disable =
  process.env.NODE_ENV !== "production" && process.env.ENABLE_AD !== "true";
const inHouseAds = [
  {
    name: "scaffoldhub",
    ...
    description:
      "<b>Scaffold</b>. Automate building your full-stack Material-UI web-app.",
  },
  {
    name: "templates",
    link:
...
function Ad(props) {
  ...
  const eventLabel = label
    ? `${label}-${ad.portal.placement}-${adShape}`
    : null;
